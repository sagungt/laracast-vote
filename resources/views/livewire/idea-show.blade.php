            ...
            <div class="w-full mx-2 md:mx-4">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    ...
                    <div class="flex md:hidden mt-4 md:mt-0">
                        ...
                        @if ($has_voted)
                            <button class="w-20 bg-blue border text-white border-blue font-bold text-xxs uppercase rounded-xl hover:bg-blue-hover transition duration-150 ease-in px-4 py-3 -mx-5">
                                Voted
                            </button>
                        @else
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        ...
        <div class="hidden md:flex items-center space-x-3">
            ...
            @else
                <button
                    type="button"
                    class="w-32 h-11 text-xs bg-gray-200 font-semibold uppercase rounded-xl border border-gray-200 hover:bg-gray-400 transition duration-150 ease-in px-6 py-3"
                >
                    <span>Vote</span>
                </button>
            @endif
