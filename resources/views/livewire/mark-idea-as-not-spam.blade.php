<div
    ...
    @custom-show-mark-idea-as-not-spam-modal.window="
        isOpen = true;
        $nextTick(() => $refs.resetSpamCounterButton.focus());
    "
    x-init="
    ...
    >
        ...
        >
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button wire:click="markAsNotSpam" x-ref="resetSpamCounterButton" type="button" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue text-base font-medium text-white hover:bg-blue-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue sm:ml-3 sm:w-auto sm:text-sm">
                    Reset Spam Counter
                </button>
